...
def wilson_lower_bound(up, down, confidence=0.95):
    ...
    - Note:
    If the scores are between 1-5, 1-3 is marked as negative, 4-5 as positive and can be made suitable for Bernoulli.

    This brings some problems with it. For this reason, it is necessary to do Bayesian average rating
